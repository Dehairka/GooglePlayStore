<template>
    <div class="defaultLayout">
      <nav>
        <h1 v-if="!$device.isMobileOrTablet"><NuxtLink to="/">Google Play</NuxtLink></h1>
        <h1 v-else>
